...
export function LoginForm() {
    ...
    <Box>
        <Stack style={{ backgroundImage: "url('https://suntrics.com/wp-content/uploads/2023/05/Drones-Help-Farmers.jpg')", backgroundSize: "cover", backgroundPosition: "center", alignItems: "center", justifyContent: "center", display: "flex" }} width="100%" minHeight="100vh" display={"flex"}>
            ...
            <Stack style={{ backgroundColor: "white", width: 410, alignItems: "center", justifyContent: "center" }}>
            <form onSubmit={(p) => {
                p.preventDefault();
                ...
                <TextField label="Username or email" style={{ width: 220, flexDirection: "column", borderRadius: 50, }} value={email} onChange={(o) => setEmail(o.target.value)} required></TextField>
                <TextField label="Password" type="password" required />
                </Stack>
                <Stack borderTop={10} borderColor={"transparent"} direction={"column"} display={"flex"} style={{ width: 220, position: "relative" }}>
                <Button variant="contained" type="submit" style={{ fontFamily: "Train_One", width: 220, borderRadius: 50, backgroundColor: "purple" }}><span>Login</span></Button>
                </Stack>
