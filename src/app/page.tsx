...
export default function Home() {
  return (
    <Stack style={{backgroundImage: "url('https://suntrics.com/wp-content/uploads/2023/05/Drones-Help-Farmers.jpg');", backgroundPosition: "center", backgroundSize: "cover", height: "100vh"}}>
      ...
      <Typography style={{backgroundImage: "linear-gradient(to bottom right, red, aqua, silver, indigo, blue)", WebkitBackgroundClip: "text", MozBackgroundClip: "text", backgroundClip: "text", color: "transparent"}} variant="h1" position={"absolute"} top={110} left={500} display={"flex"} alignItems={"center"} justifyContent={"center"} fontFamily={"Cinzel"} color={"silver"} >AICulture</Typography>
