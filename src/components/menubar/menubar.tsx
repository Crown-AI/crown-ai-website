        ...
        >
          <span
            ...
            onClick={(h) => {
              ...
              safety.style.transition = "0.6s ease-in-out";
              end.style.width = "0";
              end.style.transition = "0.6s ease-in-out";
              support.style.color = "transparent";
              support.style.transition = "0.6s ease-in-out";
              help.style.color = "transparent";
              help.style.transition = "0.6s ease-in-out";
